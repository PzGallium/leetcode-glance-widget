...
## 全年提交日历（可选）/ Full-year calendar (optional)
...
|---------------------|--------------------------------------------------------|
| 总题数 Total Solved | 显示在力扣/LeetCode 上已通过的题目总数。              |
| 通过率 Acceptance   | 有提交数据时显示；无数据时不显示该块。                 |
| 提交日历 Calendar   | 按日的提交热力图；中国站配置 Cookie 后可显示全年。     |

---

## 许可 / License

Use and modify freely. 可自由使用与修改。
